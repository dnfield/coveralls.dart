...
void main() => group('Lcov', () {
  group('parseReport()', () {
    test('should properly parse LCOV reports', () async {
      ...
      expect(job.sourceFiles.first.coverage, containsAllInOrder(subset));
      ...
      expect(job.sourceFiles[1].coverage, containsAllInOrder(subset));
      ...
      expect(job.sourceFiles[2].coverage, containsAllInOrder(subset));
    });
  });
});
